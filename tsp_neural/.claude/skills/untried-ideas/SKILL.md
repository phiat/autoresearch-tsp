...
Recommended next pick (highest novelty × lowest collision):
  M7 — Tiny single-layer attention model for partial-tour construction
        [research-modern-learned, src: Vinyals 2015 / Kool 2019]
        Untried since manual injection at cycle 31.
```
