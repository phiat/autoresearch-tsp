...
The single-seed solver is rng-luck-dependent (recap-7 RngCafe proved
this empirically: 0xBEEF → 0xCAFE swung val_cost by 978). The
**noise floor for the heuristic loop is ~500 cost units**. Discards
